...
- Removed the floating `PHASE 5 SECURITY SHELL` label from the security shell.
...
Documentation files may still mention phase history for development traceability. Public-facing UI should now avoid phase/test wording.
